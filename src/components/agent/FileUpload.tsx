...
import { cleanupPreviews, generateMarkdown, processFiles } from '@/lib/proccessingFiles';
...
export function FileUpload({ onFileSelect, onInsertMarkdown, iconOnly = false }: FileUploadProps) {
    ...
    const handleInsert = () => {
      ...
      const markdownContent = selectedFiles.map(file => generateMarkdown(file)).join('');
